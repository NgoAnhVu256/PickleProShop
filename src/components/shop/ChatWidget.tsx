...
function ZaloIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M12 4C8.6865 4 6 6.336 6 9.2175C6 10.7355 6.744 12.0925 7.92 13.005L7.44 15.665L10.224 14.123C10.812 14.285 11.43 14.375 12.048 14.375C15.3615 14.375 18 12.0385 18 9.1575C18 6.336 15.3135 4 12 4ZM12 4.978C14.784 4.978 17.04 6.874 17.04 9.2175C17.04 11.5615 14.784 13.4575 12 13.4575C11.544 13.4575 11.1 13.4095 10.674 13.3195L10.434 13.2655L10.26 13.3855L9.12 14.1715L9.438 12.9295L9.486 12.7375L9.318 12.6055C8.358 11.8555 7.782 10.8595 7.782 9.7375C7.782 7.3935 10.038 5.4975 12.822 5.4975V4.978ZM9.84 7.498H13.68V8.458H9.84V7.498ZM9.84 9.418H13.68V10.378H9.84V9.418ZM9.84 11.338H12.48V12.298H9.84V11.338Z" fill="white" />
    </svg>
  );
}
