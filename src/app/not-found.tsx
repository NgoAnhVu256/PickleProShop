    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 max-w-5xl w-full px-6 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        <div className="relative group w-full lg:w-1/2 flex justify-center">
          <div className="absolute inset-0 bg-lime/20 blur-[100px] rounded-full animate-pulse" />
          <img 
            src="/404-char.png" 
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left text-white">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
            <Link 
              href="/" 
              className="group flex items-center gap-3 bg-white text-gray-900 px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-accent hover:text-white transition-all shadow-xl hover:shadow-accent/40"
            >
      ...
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-lime/10 rounded-full blur-3xl animate-pulse" />
