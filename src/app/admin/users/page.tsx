...
import { Search, Users, Shield, ShieldCheck, Trash2, Loader2, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #eef2f7", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", overflow: "hidden" }}>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ background: "#fafbfc" }}>
                  {["Người dùng", "Email", "Quyền", "Đơn hàng", "Ngày tạo", "Thao tác"].map((h) => (
              ...
              <tbody>
                ...
                {users.length === 0 && (
                  <tr>
                    <td colSpan={6} style={{ textAlign: "center", padding: 60, color: "#b0bac9", fontSize: 14 }}>
        ...
        {totalPages > 1 && (
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 12, padding: 16, borderTop: "1px solid #eef2f7" }}>
            ...
            <span style={{ fontSize: 13, color: "#8a98ac", fontWeight: 600 }}>
